...
?>
		<div id="left-list-part">
        	<h1>Arrowhead Dentists</h1>
            <ul class="Drlist">
            	<li>
                <div class="addr">
                	<h2>Dr. Dale MAchine Inc.</h2>
                    <h3>Address</h3>
                    <p>202-20644 Eastleigh Crescent, Langley,<br/> British Columbia, Canada, <br/>
                     Zip code: 34</p>
            	    <h3>Phone</h3>
                    <p>(404) 355-2001 </p>
                    <h3>Speciality</h3>
                    <p>General Dentistry, Preventative Dentistry </p>
                    </div>
                    <img src="" />
                </li>
        ...
        <ul>
            ...
            <li><a class="selected" href="index-page-2.php">2</a></li>
            <li><a href="index-page-3.php">3</a></li>
            <li><a href="index-page-4.php">4</a></li>
        </ul>
        </div>
        </div><!--end left-list-->
